...
- `ANTHROPIC_API_KEY`: preparación de especificaciones visuales.
- `OPENAI_API_KEY`: generación o edición de recursos conceptuales.
- `BLOTATO_API_KEY`: programación.
- `MEDIA_REPO_TOKEN`: publicación de medios.

Nunca guardar claves en manifiestos, contratos, prompts o commits.

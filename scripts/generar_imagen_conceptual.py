...
La composición final no ocurre aquí. Este script produce una capa visual
trazable para el renderer de Motion.
"""
...
def main() -> int:
    ...
    if execution == "reuse":
        ...
        try:
            ...
            raise RuntimeError("Instalá openai: pip install openai") from exc
